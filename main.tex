...
constantenmente y generan una cantidad inmensa de datos. Además de esto, actualmente, contamos con gran poder computacional
accesible y a bajo costo. En este contexto, ha surgido la necesidad de procesar los datos para convertirlos
ya sea en productos o decisiones accionables.
...
Tratándose de la materia prima de la disciplina, es necesario distinguir las cosas que consideramos como datos y que
podemos análizar de las que no. Según \textcite{Garzon2022}:
\begin{quote}
