...
\subsubsection{Proyección Lineal de un Dato}
...
\subsubsection{Las matrices de centrado}
...
\begin{definition}
    ...
    donde
    $$\mu_{rows} = \frac{1}{d} \sum^p_{i = 1} c_i$$
...
\subsubsection{La Proyección de Múltiples Datos}
